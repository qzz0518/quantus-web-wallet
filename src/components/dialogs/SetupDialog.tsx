        ...
        <div className="flow-body">
          ...
          {deviceEnabled && (
            <>
              ...
              <p className="hint centered">{t("或使用密码解锁")}</p>
            </>
          )}
          {mode === "restore" && (
          ...
          <div className="soft-note">
            <ShieldCheck size={17} />
            <p>
              {t("密码用于解锁当前设备。请保管好助记词和加密备份，以便恢复钱包。")}
            </p>
          </div>
        </div>
