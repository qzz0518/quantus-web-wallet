...
**Costs.** The chain charges a 0.04% volume fee on the withdrawn amount. Amounts are rounded down to 0.01 QTC first, and the remainder below 0.01 QTC of each deposit is lost. Half of the fee is burned and half goes to the block producer; there is no rebate. Proof generation needs about 1.5 GB of memory and roughly a minute; a desktop browser is recommended.
